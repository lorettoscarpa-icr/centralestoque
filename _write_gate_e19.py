"""
Grava appVerMin='e19' (fecha o botão de reimprimir etiquetas de lote EM
PRODUÇÃO mesmo depois de lançado — 23/09/2026, pedido do Gregory — ver
RELATORIO_REIMPRESSAO_23SET.md) nos 3 docs de fábrica em ls_pe (manutt,
tarragona, tchwm-industria-e-comercio-de-calcados-ltda) e no doc global
ls_pe_config/loja (fonte do overlay bloqueante de UI — ver index.html,
...
estoque, produzindo, ordens, lotesProducao etc. Não toca no doc legado
(_ujl3p9sjjv).

Só roda depois de confirmar via curl que o GitHub Pages já serve app-ver
e19 — gravar appVerMin antes disso travaria quem ainda não tem como
atualizar.
"""
import time
...
def grava_fabrica(did):
    ...
    def tx_fn(tx):
        ...
        entry = {
            ...
            "tipo": "gate de versão e19 — botão reimprimir etiquetas de lote/produzindo",
            "mudancas": [],
        }
        tx.set(
            ref,

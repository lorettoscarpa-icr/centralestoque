"""
Grava appVerMin='e15' (funil de escrita evoluído: fila de pendentes + anti-eco
no autosave da grade da fábrica, 22/09/2026) nos 3 docs de fábrica em ls_pe
...
def grava_fabrica(did):
    ...
    def tx_fn(tx):
        ...
        entry = {
            ...
            "tipo": "gate de versão e15 — fila de pendentes + anti-eco no autosave",
            "mudancas": [],
        }
        tx.set(
            ref,
